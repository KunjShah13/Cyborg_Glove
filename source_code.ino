...
#define sw1 8 //switch 2 at pin 8
...
#define echoPin 0 // attach pin 1 Arduino to pin Echo of HC-SR04
#define trigPin 1 //attach pin 0 Arduino to pin Trig of HC-SR04
